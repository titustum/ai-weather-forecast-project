...
class MultipleTrainer():
	"""This class loads and trains using neural networks models on list of inputed variables"""
	def __init__(self, conditions=['temperature', 'humidity', 'pressure'], cities=['Toronto', 'Houston'], epochs=1, datasamples=1000, display_graphs=False):
	...
	"""Set the conditions of what you want train for network to use"""
	...
	def train_multiple(self):
		"""Loop through all the conditions given"""
		print("\n\n=============Training started===============================")
		for condition in self.conditions:
			...
			for city in self.cities:
				...
				if not os.path.exists(f"../models/{city}/{condition}/"):
					os.makedirs(f"../models/{city}/{condition}/")
				model.save(f"../models/{city}/{condition}/{self.datasamples}_samples_{myrmse}_error.h5")
	...
	def display_graph(self):
		...
		# plt.plot(train["Toronto"], 'g', label="Training Data")
